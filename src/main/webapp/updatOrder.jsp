...
<%
  ...
  conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/PetMaster","root","admin");
  ...
  try
  {
   sqlInsertRecord="insert into pedidosvenda (CustID, custName, CustEmail, CustAdress, ProductID, custPhone) values(?,?,?,?,?,?)";
...
<html>
 <head>
      <meta http-equiv="REFRESH" content="3;url=/PetMasterMaven/Home.jsp">
    </head>
<body>
